...
def test_filter_by_currency(currency, expected_ids, transactions):
    currency_transactions = filter_by_currency(transactions, currency)
    result = [next(currency_transactions)["id"] for _ in range(len(expected_ids))]
...
def test_transaction_descriptions(expected_descriptions, transactions):
    descriptions = transaction_descriptions(transactions)
    result = [next(descriptions) for _ in range(len(expected_descriptions))]
